...
class Idea{
    ...
    public Idea(int id, int putTime, int dengji, int needTime) {
        this.id = id;
...
public class Main4 {
    ...
    public static void main(String[] args) {
        ...
        int numOfPM = sc.nextInt();
        int numOfProgrammer = sc.nextInt();
        int numOfIdea = sc.nextInt();

        ArrayList<Idea> arrayList = new ArrayList<>();
//        Idea a = new Idea(1, 1, 1, 1);
//        Idea b = new Idea(1, 1, 2, 1);
        arrayList.sort((a,b)->(a.dengji-b.dengji));
